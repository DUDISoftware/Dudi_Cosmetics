...
router.get("/Product/products-list", verifyToken, getAllProducts);
router.get("/Product/products-detail/:id", verifyToken, getProductById);
...
router.get("/ProductBrand/ProductBrand-detail/:id", verifyToken, getProductBrandById);
...
router.get("/PCParent/PCParent-list", verifyToken, getAllPCParent);
router.get("/PCParent/PCParent-detail/:id", verifyToken, getPCParentId);
...
router.get("/PCChild/PCChild-list", verifyToken, getAllPCChild);
router.get("/PCChild/PCChild-detail/:id", verifyToken, getPCChildById);
...
router.get("/PostsCategory/PostsCategory-list", verifyToken, getAllCategoryPost);
router.get("/PostsCategory/PostsCategory-detail/:id", verifyToken, getCategoryPostSById);
...
router.get("/Posts/Posts-list", verifyToken, getAllPost);
router.get("/Posts/Posts-detail/:id", verifyToken, getPostSById);
